...
@Component({
  ...
  styleUrl: './bills-new.scss',
})
export class BillsNew implements OnInit {
  ...
  ngOnInit(): void {
    // Initial dates left empty to match design placeholders
  }
  ...
  saveAsDraft(): void {
    console.log('Draft Bill:', this.billData);
